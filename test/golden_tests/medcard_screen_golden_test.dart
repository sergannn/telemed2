...
void main() {
  group('MedCardScreen Golden Tests (Doctor)', () {
    setUpAll(() async {
      SharedPreferences.setMockInitialValues({});
      await Session.init();
    });

    testWidgets('MedCardScreen - initial state', (WidgetTester tester) async {
      ...
      await expectLater(
        scaffoldFinder,
        matchesGoldenFile('golden/medcard_screen_initial.png'),
      );
