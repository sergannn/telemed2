...
class MedicineWebView extends StatefulWidget {
  const MedicineWebView({super.key});

  @override
  State<MedicineWebView> createState() => _MedicineWebViewState();
}

class _MedicineWebViewState extends State<MedicineWebView> {
