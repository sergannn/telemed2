...
//    return Text("a");
              ...
              children: [
                ...
                CustomButton(
                  ...
                  onTap: () async {
                    ...
                    MyOverlay.show(context);
                    try {
                      final tokenSaved = await FcmService().saveTokenForRegistration(
  ...
  bool validateForm() {
    ...
    if (isValid && _selectedCity == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Выберите город из списка подсказок")),
      );
      return false;
    }
    return isValid;
            ...
            decoration: InputDecoration(
              ...
              border: OutlineInputBorder(
                ...
                borderSide: BorderSide(
                  color:
                      hasError ? ColorConstant.redA400 : ColorConstant.bluegray50,
                  width: 1,
                ),
              ),
              ...
              filled: true,
              fillColor:
                  hasError ? ColorConstant.fromHex("FFEDED") : ColorConstant.whiteA700,
              isDense: true,
  ...
  Future<CityOption?> _showCityPicker(
    ...
    List<CityOption> filtered = searchController.text.trim().isEmpty
        ...
        : cities
            .where(
              (city) =>
                  CityCatalogService.matches(city, searchController.text.trim()),
            )
            .take(30)
            .toList();
                        ...
                        onChanged: (value) {
                          setSheetState(() {
                            ...
                            filtered = (query.isEmpty
                                    ...
                                    : cities.where(
                                        (city) =>
                                            CityCatalogService.matches(city, query),
                                      ).take(30))
                                .toList();
                          });
                        },
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            subtitle: option.subtitle == null
                                ...
                                : Text('${option.subtitle} · ${option.timeZone}'),
