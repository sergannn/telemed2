  ...
  Widget whatFor(context) {
    return Column(children: <Widget>[
      ExpansionTile(
        ...
        children: <Widget>[ListTile(title: Text('Если вы хотите что-то уточнить у данного врача, воспользуйтесь повторной онлайн консультацией в формате чата или запишитесь на другой формат консультации.'))],
      )
    ]);
  }
