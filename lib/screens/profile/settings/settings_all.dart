...
class _SettingsAllScreenState extends State<SettingsAllScreen> {
  ...
  void didChangeDependencies() {
    ...
    _themeEnabled = AdaptiveTheme.of(context).mode.isDark;
  }
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.only(
                          topLeft: Radius.circular(
                              22), // Скругление верхнего левого угла
                          topRight: Radius.circular(
                              22), // Скругление верхнего правого угла
                        ),
                      ),
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.only(
                          bottomLeft: Radius.circular(
                              22), // Скругление нижнего левого угла
                          bottomRight: Radius.circular(
                              22), // Скругление нижнего правого угла
                        ),
                      ),
                      child: Container(
                        padding: const EdgeInsets.symmetric(
